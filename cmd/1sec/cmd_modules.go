...
var allModules = []moduleInfo{
	...
	{"iot_shield", "Device fingerprinting, protocol anomaly, firmware integrity, default credential detection", 1, "Network & Perimeter",
	...
	{"ransomware", "Encryption detection (threshold: 5), canary files, exfiltration detection, wiper detection", 2, "Application Layer",
