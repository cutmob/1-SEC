...
var allModules = []moduleInfo{
	...
	{"ai_containment", "Action sandboxing, shadow AI detection, OWASP Agentic AI Top 10 coverage, tool integrity monitoring, goal hijack detection, memory poisoning detection, cascade failure monitoring", 4, "AI-Specific Defense",
		[]string{"ai_action", "model_deploy", "shadow_ai_detected", "tool_invocation", "agent_goal", "agent_memory"}},
	{"data_poisoning", "Training data integrity, RAG verification, adversarial input detection, model supply chain attack detection (slopsquatting, unsigned models)", 4, "AI-Specific Defense",
		[]string{"training_data", "rag_query", "adversarial_input", "model_download", "model_registry"}},
