...
func cmdHelp(subcmd string) {
	...
	case "config":
		...
		fmt.Printf("  %-20s  %s\n", "set-key <key> ...", "Set Gemini API key(s) for AI analysis")
		fmt.Printf("\n%s\n\n", bold("FLAGS"))
		...
		fmt.Printf("  1sec config set-key AIzaSy...\n")
		fmt.Printf("  1sec config set-key --show\n")
		fmt.Printf("  1sec config set-key --env\n")
	case "check":
		fmt.Printf("%s\n\n", bold("1sec check"))
	...
	case "init":
		...
		fmt.Printf("  %-28s  %s\n", "--ai", "Prompt for Gemini API key after generating config")
		fmt.Printf("  %-28s  %s\n", "--force", "Overwrite existing file without prompting")
		fmt.Printf("\n%s\n\n", bold("EXAMPLES"))
		fmt.Printf("  1sec init\n")
		fmt.Printf("  1sec init --minimal\n")
		fmt.Printf("  1sec init --ai\n")
		fmt.Printf("  1sec init --output /etc/1sec/config.yaml --force\n")
	case "docker":
		fmt.Printf("%s\n\n", bold("1sec docker"))
	...
	case "setup":
		fmt.Printf("%s\n\n", bold("1sec setup"))
		fmt.Printf("Guided interactive setup wizard. Walks you through config creation,\n")
		fmt.Printf("AI key setup (BYOK), and API security in one flow.\n\n")
		fmt.Printf("%s\n\n", bold("FLAGS"))
		fmt.Printf("  %-28s  %s\n", "--config <path>", "Config file path (default: 1sec.yaml)")
		fmt.Printf("  %-28s  %s\n", "--ai-only", "Only configure AI (Gemini) API keys")
		fmt.Printf("  %-28s  %s\n", "--non-interactive", "Use env vars, skip prompts")
		fmt.Printf("  %-28s  %s\n", "--profile <name>", "Named profile to use")
		fmt.Printf("\n%s\n\n", bold("EXAMPLES"))
		fmt.Printf("  1sec setup\n")
		fmt.Printf("  1sec setup --ai-only\n")
		fmt.Printf("  GEMINI_API_KEY=xxx 1sec setup --non-interactive\n")
	case "doctor":
		fmt.Printf("%s\n\n", bold("1sec doctor"))
		fmt.Printf("Comprehensive health check with actionable fix suggestions.\n")
		fmt.Printf("Goes beyond 'check' by detecting misconfigurations, checking\n")
		fmt.Printf("AI readiness, and suggesting specific commands to fix issues.\n\n")
		fmt.Printf("%s\n\n", bold("FLAGS"))
		fmt.Printf("  %-28s  %s\n", "--config <path>", "Config file path")
		fmt.Printf("  %-28s  %s\n", "--profile <name>", "Named profile to use")
		fmt.Printf("\n%s\n\n", bold("EXAMPLES"))
		fmt.Printf("  1sec doctor\n")
		fmt.Printf("  1sec doctor --config /etc/1sec/prod.yaml\n")
		fmt.Printf("  1sec doctor --profile prod\n")
	default:
